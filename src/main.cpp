#ifdef __APPLE__
#define VK_ENABLE_BETA_EXTENSIONS // 添加 VK_ENABLE_BETA_EXTENSIONS 宏定义
#endif
...
#ifdef __APPLE__
        VK_KHR_PORTABILITY_SUBSET_EXTENSION_NAME, // 添加 VK_KHR_PORTABILITY_SUBSET_EXTENSION_NAME 扩展
#endif
};
...
#ifdef __APPLE__
        extensions.push_back(VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME); // 添加 VK_KHR_PORTABILITY_SUBSET_EXTENSION_NAME 扩展
#endif
        createInfo.enabledExtensionCount = static_cast<uint32_t>(extensions.size());
        createInfo.ppEnabledExtensionNames = extensions.data();
#ifdef __APPLE__
        createInfo.flags |= VK_INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR; // 添加 VK_INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR 标志
#endif
